...
typedef NS_ENUM(int, ARDSettingsSections) {
  ...
  ARDSettingsSectionApprtcServer,
};
...
- (nullable NSString *)tableView:(UITableView *)tableView
  ...
  switch (section) {
    ...
    case ARDSettingsSectionApprtcServer:
      return @"Apprtc server url";
    default:
      return @"";
  }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  switch (indexPath.section) {
    ...
    case ARDSettingsSectionApprtcServer:
      return [self apprtcServerTableViewCellForTableView:tableView atIndexPath:indexPath];
    default:
...
- (UITableViewCell *)apprtcServerTableViewCellForTableView:(UITableView *)tableView
                                          atIndexPath:(NSIndexPath *)indexPath {
    NSString *dequeueIdentifier = @"ARDSettingsSectionApprtcServerCellIdentifier";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:dequeueIdentifier];
    if (!cell) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault
                                      reuseIdentifier:dequeueIdentifier];
        ...
        UITextField *textField = [[UITextField alloc]
                                  initWithFrame:CGRectMake(10, 0, cell.bounds.size.width - 20, cell.bounds.size.height)];
        NSString *apprtcServer = [_settingsModel currentApprtcServerSettingFromStore];
        textField.text = apprtcServer;
        textField.placeholder = @"https://apprtc.xiaominfc.com";
...
- (void)textFieldDidEndEditing:(UITextField *)textField {
    ...
    if(textField.keyboardType == UIKeyboardTypeURL){
        [_settingsModel storeApprtcServerSetting:value];
        return;
    }
    
  NSNumber *bitrateNumber = [NSNumber numberWithInteger:textField.text.intValue];
